...
<head>
  ...
  function displayGraph(){
    ...
    function drawChart() {
      var jsonData = $.ajax({
        url: "leastdata.php?&year="+year+"&indices="+index,
        dataType:"json", 
        async: false, 
                    ...
                    <ul class="nav">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="../map/index2.php">Readiness and ND Gain</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="../anomaly/aline.php">Z Score Calculation</a></li>
	...
	<div class="container">
     ...
     <tr id="tableRow">
        ...
        <td valign="top">
            ...
            <input id="action" type="button" onclick="displayGraph();" value="Display Graph"/>
            </td>
</tr>
