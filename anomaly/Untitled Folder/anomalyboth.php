...
<head>
	...
	<title>Climate Change:Vulnerability Analysis and Anomaly Detection</title>
...
<script type="text/javascript" src="include/jsapi"></script>
  ...
  function displayGraph(){
    ...
    function drawChart() {
      var jsonData = $.ajax({
        url: "anomaly_score.php?&country="+country+"&indices="+index,
        dataType:"json", 
        async: false, 
      ...
      var options = {'title': 'LineGraph of Various Indices',
...
<header class="navbar navbar-fixed-top">
                    ...
                    <ul class="nav">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="../map/index.html">Vulnerability</a></li>
                                <li><a href="blog-item.html">Readiness and ND Gain</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="career.html">Line Graphs</a></li>
                                <li><a href="blog-item.html">Bar Graphs</a></li>
                            </ul>
                        </li>
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Regression <i class="icon-angle-down"></i></a>
                            <ul class="dropdown-menu">
                                <li><a href="career.html">Carbon VS ND GAin Index</a></li>
                                <li><a href="blog-item.html">ND Gain VS Vulnerability </a></li>
                                <li><a href="#" target ="blank">ND Gain VS Readiness </a></li>
                            </ul>
                        </li>
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">ScatterPlot <i class="icon-angle-down"></i></a>
                            <ul class="dropdown-menu">
                                <li><a href="career.html">Carbon VS ND GAin Index</a></li>
                                <li><a href="blog-item.html">ND Gain VS Vulnerability </a></li>
                                <li><a href="#" target ="blank">ND Gain VS Readiness </a></li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="career.html">Z-Value </a></li>
                                <li><a href="blog-item.html">P Value</a></li>
                                
                            </ul>
                        </li>
                        <li><a href="blog.html">Prediction</a></li> 
	...
	<div class="container">
		<div class="header">
			<h3 style="margin-top: 50px;">Line Graph of Various Indic</h3>
			<h3>1995-2011</h3>
			<br></br>
		</div>
