...
<html>
    <head>
        ...
        <title>Camparison Line Charts</title>
  ...
  function displayGraph(){
    ...
    function drawChart() {
      var jsonData = $.ajax({
        url: "multipledata.php?&countryone="+countryone+"&indices="+index+"&countrytwo="+countrytwo,
        dataType:"json", 
        async: false, 
...
<script>
$(document).ready(function() { $("#myCountryone").select2({ width: 'resolve' }); });
$(document).ready(function() { $("#myCountrytwo").select2({ width: 'resolve' }); });
