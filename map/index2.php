...
<header class="navbar navbar-fixed-top">
                    ...
                    <ul class="nav">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="index2.php">Readiness</a></li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="../anomaly/aline.php">Anomaly Score</a></li>
                                <li><a href="../anomaly/pline.php">P Value Score </a></li>
	...
	<div class="container">
		<div class="header">
			<h1 class="headingc">Readiness Indices</h1>
			<h3>1995-2011</h3>
		      ...
		      .onload(function(thegoods) {
			    	...
			    	byName = (function() {
						...
						legend.selectAll('.growth-points')
								...
								.enter().append('rect')
									...
									.attr('fill',function(d) { return color(d*10); })
									.attr('y',ly)
									.attr('width',9)
									.attr('height',10);
						legend.append('text')
				...
				function updateCountryInfo(c,y) {
					if ( typeof c === 'undefined' ) {
						...
						var allyears = availableDataForCountry(c);
						if ( !allyears || allyears.length == 0 ) {
							...
							if (typeof growth === 'undefined' || growth.length == 0 ) {
								...
								growth = String(Number(growth).toFixed(2)) + "";
							}
							...
							//customized tooltip
							$('.i-country').text(c.name);
							$('.i-country-gdp').text("Index: "+ growth);
							$('.i-country-mean').text(y)
