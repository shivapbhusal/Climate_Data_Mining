...
<head>
	...
	<title> Vulnearbility Indices (1995-2011)</title>
...
<header class="navbar navbar-fixed-top">
	...
	<div class="container">
		<div class="header">
			<h1 class="headingc">Vulnerability Indices</h1>
			<h3>1995-2011</h3>
		      	...
		      	combinedData = thegoods.countries.features.equijoin(thegoods.codes, {
			    	...
			    	byName = (function() {
						...
						legend.append('text')
							...
							$('.i-country').text("0.2-0.4 : High Vulnerable");			
							$('.i-country-gdp').text("0.4-0.6: MOderate Vulnerable");
							$('.i-country-mean').text("0.6-0.8 : Least Vulnerable");
							;
